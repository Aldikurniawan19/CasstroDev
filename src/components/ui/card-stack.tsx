  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto h-40 w-[76%] rounded-full bg-text-main/10 blur-3xl"
          aria-hidden="true"
        />
            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    "absolute bottom-0 rounded-2xl border-4 border-border-subtle dark:border-white/10 overflow-hidden shadow-xl",
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on
                      ? "bg-text-main"
                      : "bg-text-main/30 hover:bg-text-main/50",
                  )}
    ...
    <div className="relative h-full w-full">
      ...
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-secondary text-sm text-text-muted">
            No image
          </div>
        )}
      </div>
